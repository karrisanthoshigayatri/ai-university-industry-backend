...
def upgrade() -> None:
    """Create the problem and problem_evidence tables."""
    ...
    op.create_index("ix_problem_evidence_problem_id", "problem_evidence", ["problem_id"])
    op.create_index("ix_problem_evidence_submitted_by", "problem_evidence", ["submitted_by"])
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index("ix_problem_evidence_verification_status", table_name="problem_evidence")
    op.drop_index("ix_problem_evidence_submitted_by", table_name="problem_evidence")
    op.drop_index("ix_problem_evidence_problem_id", table_name="problem_evidence")
